...
background-size:cover;
  ...
  <table class="table">
    ...
    <br>
    <p><h1 style="color:#60c96e">Textos Escolares</h1></p>
...
<!-- items -->
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <center>
          ...
          <thead>
            <tr>
              ...
              <th scope="col">
                ...
                <img src="https://www.loqueleo.com/co/uploads/2018/04/el-perfume-del-viento.jpg" class="card-img-top" width="300" height="350">
                <div class="card-body">
                  <p class="card-text">El perfume del viento</p>
                </div>
              </div>
            </th>
          ...
          <th scope="col">
          <div class="card" style="width: 18rem; background-color: #bd69af; ">
            <img src="https://www.planetadelibros.com.co/usuaris/libros/fotos/245/m_libros/portada_mi-abuela-la-loca_jose-ignacio-valenzuela_201611251712.jpg" class="card-img-top" width="300" height="350">
            <div class="card-body">
              <p class="card-text">Mi abuela, la loca</p>
            </div>
          </div>
        </th>
      ...
      <th scope="col">
        <div class="card" style="width: 18rem; background-color: #bd69af; ">
        <img src="https://www.loqueleo.com/ar/uploads/2015/11/resized/800_9789504643883.jpg" class="card-img-top" width="300" height="350">
        <div class="card-body">
          <p class="card-text">El juego del laberinto</p>
        </div>
      </div>
    </th>
      ...
      <div class="carousel-item">
          ...
          <table class="table table-borderless">
            <thead>
              <tr>
                ...
                <th scope="col">
                  <div class="card" style="width: 18rem; background-color: #bd69af; ">
                  <img src="https://www.planetadelibros.com.co/usuaris/libros/fotos/169/m_libros/scorpio-city-nva-presentacion_9789584239426.jpg" class="card-img-top" width="300" height="350">
                  <div class="card-body">
                    <p class="card-text">Scorpio City</p>
                  </div>
                </div>
              </th>
            ...
            <th scope="col">
            <div class="card" style="width: 18rem; background-color: #bd69af; ">
            <img src="https://image.cdn0.buscalibre.com/5dbb5b183fc861f4508b4567.__RS360x360__.jpg" class="card-img-top" width="300" height="350">
            <div class="card-body">
              <p class="card-text">Hola, tristeza</p>
            </div>
          </div>
        </th>
        ...
        <th scope="col">
          <div class="card" style="width: 18rem; background-color: #bd69af; ">
          <img src="https://www.libreriapensar.com/wp-content/uploads/2020/04/image_15700.jpg" class="card-img-top" width="300" height="350">
          <div class="card-body">
            <p class="card-text">Geometría y trigonometría</p>
          </div>
        </div>
      </th>
  ...
  <table class="table table-borderless">
            ...
            <th scope="col">
              <div class="card" style="width: 18rem; background-color: #bd69af;">
                <img src="https://www.loqueleo.com/co/uploads/2018/08/9789585444362.jpg" class="card-img-top"  width="300" height="350">
                <div class="card-body">
                  <h5 class="card-title">Diario de un suplente</h5>
                  <p class="card-text">Fernando Escobar Borrero</p>
          ...
          <th scope="col">
            <div class="card" style="width: 18rem; background-color: #bd69af;">
              <img src="https://panamericana.vteximg.com.br/arquivos/ids/344846-325-325/vivo-la-paz-7-9789580519126.jpg?v=637146369205170000" class="card-img-top"  width="300" height="350">
              <div class="card-body">
                <h5 class="card-title">Vivo la Paz 7</h5>
                <p class="card-text">Santiago Martínez  Cordero</p>
                <a href="#" class="btn btn-primary">Obtenlo</a>
              </div>
            </div>
        </th>
    ...
    <table class="table table-borderless">
      ...
      <th scope="col">
        <div class="card" style="width: 18rem; background-color: #bd69af;">
          <img src="https://www.normainfantilyjuvenil.com/ar/uploads/2019/05/9789580407379.jpg" class="card-img-top"  width="300" height="350">
          <div class="card-body">
            <h5 class="card-title">Por todos los dioses ...!</h5>
            <p class="card-text">Ramón García Domínguez</p>
            <a href="#" class="btn btn-primary">Obtenlo</a>
          </div>
        </div>
    </th>
    ...
    <th scope="col">
      <div class="card" style="width: 18rem; background-color: #bd69af;">
        <img src="https://www.normainfantilyjuvenil.com/ar/uploads/2019/05/resized/800_9789875456303_1.jpg" class="card-img-top"  width="300" height="350">
        <div class="card-body">
          <h5 class="card-title">Las maletas de Auschwitz</h5>
          <p class="card-text">Daniela Palumbo</p>
          <a href="#" class="btn btn-primary">Obtenlo</a>
        </div>
      </div>
  </th>
...
<table class="table table-borderless">
  ...
  <th scope="col">
    <div class="card" style="width: 18rem; background-color: #bd69af;">
      <img src="https://www.planetadelibros.com.co/usuaris/libros/fotos/243/m_libros/portada_paranormal-colombia-planeta-lector_mario-mendoza_201908212106.png" class="card-img-top"  width="300" height="350">
      <div class="card-body">
        <h5 class="card-title">Paranormal Colombia</h5>
        <p class="card-text">Mario Mendoza</p>
        <a href="#" class="btn btn-primary">Obtenlo</a>
      </div>
    </div>
</th>
...
<th scope="col">
  <div class="card" style="width: 18rem; background-color: #bd69af;">
    <img src="https://www.popularlibros.com/imagenes_grandes/9788468/978846834119.JPG" class="card-img-top"  width="300" height="350">
    <div class="card-body">
