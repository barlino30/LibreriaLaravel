...
background-size:cover;
  ...
  <table class="table">
    ...
    <br>
    <p><h1 style="color:#60c96e">Libros Profesionales y Especializados</h1></p>
...
<!-- items -->
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <center>
          ...
          <thead>
            <tr>
              ...
              <th scope="col">
                ...
                <img src="https://www.planetadelibros.com.co/usuaris/libros/fotos/259/m_libros/portada_felicidad-a-prueba-de-oficinas_sylvia-ramirez_201708101953.jpg" class="card-img-top" width="300" height="350">
                <div class="card-body">
                  <p class="card-text">Felicidad a prueba de oficinas</p>
                </div>
              </div>
            </th>
          ...
          <th scope="col">
          <div class="card" style="width: 18rem; background-color: #bd69af; ">
            <img src="https://www.planetadelibros.com.co/usuaris/libros/fotos/243/m_libros/portada_la-sabiduria-del-lider_jann-e-freed_201611152043.jpg" class="card-img-top" width="300" height="350">
            <div class="card-body">
              <p class="card-text">La sabiduría del líder</p>
            </div>
          </div>
        </th>
      ...
      <th scope="col">
        <div class="card" style="width: 18rem; background-color: #bd69af; ">
        <img src="https://imagessl2.casadellibro.com/a/l/t5/92/9786075276892.jpg" class="card-img-top" width="300" height="350">
        <div class="card-body">
          <p class="card-text">Dar el salto</p>
        </div>
      </div>
    </th>
      ...
      <div class="carousel-item">
          ...
          <table class="table table-borderless">
            <thead>
              <tr>
                ...
                <th scope="col">
                  <div class="card" style="width: 18rem; background-color: #bd69af; ">
                  <img src="https://image.slidesharecdn.com/g-indicadoresdegestion-jb-150914234930-lva1-app6891/95/g-indicadores-degestionjb-1-638.jpg?cb=1442274699" class="card-img-top" width="300" height="350">
                  <div class="card-body">
                    <p class="card-text">Indicadores de Gestión</p>
                  </div>
                </div>
              </th>
            ...
            <th scope="col">
            <div class="card" style="width: 18rem; background-color: #bd69af; ">
            <img src="https://www.planetadelibros.com.co/usuaris/libros/fotos/250/m_libros/portada_originales_adam-grant_201704111944.jpg" class="card-img-top" width="300" height="350">
            <div class="card-body">
        ...
        <th scope="col">
          <div class="card" style="width: 18rem; background-color: #bd69af; ">
          <img src="https://imagessl2.casadellibro.com/a/l/t5/52/9788417780852.jpg" class="card-img-top" width="300" height="350">
          <div class="card-body">
            <p class="card-text">Cada Cosa En Su Lugar</p>
          </div>
        </div>
      </th>
  ...
  <table class="table table-borderless">
            ...
            <th scope="col">
              <div class="card" style="width: 18rem; background-color: #bd69af;">
                <img src="https://www.planetadelibros.com/usuaris/libros/fotos/253/m_libros/portada_el-lenguaje-de-las-ciudades_deyan-sudjic_201705312332.jpg" class="card-img-top"  width="300" height="350">
                <div class="card-body">
                  <h5 class="card-title">El lenguaje de las ciudades</h5>
                  <p class="card-text">Deyan Sudjic</p>
          ...
          <th scope="col">
            <div class="card" style="width: 18rem; background-color: #bd69af;">
              <img src="https://www.panamericanaeditorial.com.co/2474-thickbox_default/el-sida-en-primera-persona.jpg" class="card-img-top"  width="300" height="350">
              <div class="card-body">
                <h5 class="card-title">El Sida en primera persona</h5>
                <p class="card-text">Ricardo Luque Nuñez</p>
                <a href="#" class="btn btn-primary">Obtenlo</a>
              </div>
            </div>
        </th>
    ...
    <table class="table table-borderless">
      ...
      <th scope="col">
        <div class="card" style="width: 18rem; background-color: #bd69af;">
          <img src="https://libreriadelau.vteximg.com.br/arquivos/ids/12857319-200-300/neurociencias-para-tu-vida-9789506418830-edga.jpg?v=637039977888830000" class="card-img-top"  width="300" height="350">
          <div class="card-body">
            <h5 class="card-title">Neurociencias para tu vida</h5>
            <p class="card-text">Néstor Braidot</p>
            <a href="#" class="btn btn-primary">Obtenlo</a>
          </div>
        </div>
    </th>
    ...
    <th scope="col">
      <div class="card" style="width: 18rem; background-color: #bd69af;">
        <img src="https://images-na.ssl-images-amazon.com/images/I/81UVA6ywMML.jpg" class="card-img-top"  width="300" height="350">
        <div class="card-body">
          <h5 class="card-title">El fin del Alzheimer</h5>
          <p class="card-text">Dale E. Bredesen</p>
          <a href="#" class="btn btn-primary">Obtenlo</a>
        </div>
      </div>
  </th>
...
<table class="table table-borderless">
  ...
  <th scope="col">
    <div class="card" style="width: 18rem; background-color: #bd69af;">
      <img src="https://www.planetadelibros.com/usuaris/libros/fotos/292/m_libros/portada_el-laberinto-cuantico_paul-halpern_201901240105.jpg" class="card-img-top"  width="300" height="350">
      <div class="card-body">
        <h5 class="card-title">El laberinto cuántico</h5>
        <p class="card-text">Paul Halpern</p>
        <a href="#" class="btn btn-primary">Obtenlo</a>
      </div>
    </div>
</th>
...
<th scope="col">
  <div class="card" style="width: 18rem; background-color: #bd69af;">
    <img src="https://http2.mlstatic.com/guia-para-viajeros-del-cielo-astonomia-con-binoculares-D_NQ_NP_921134-MCO26506910583_122017-F.webp" class="card-img-top"  width="300" height="350">
    <div class="card-body">
      <h5 class="card-title">Guía para viajeros del cielo</h5>
      <p class="card-text">Germán Puerta Restrepo</p>
      <a href="#" class="btn btn-primary">Obtenlo</a>
    </div>
  </div>
</th>
