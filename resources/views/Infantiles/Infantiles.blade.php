...
background-size:cover;
  ...
  <table class="table">
    ...
    <br>
    <p><h1 style="color:#60c96e">Libros Infantiles</h1></p>
...
<!-- items -->
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <center>
          ...
          <thead>
            <tr>
              ...
              <th scope="col">
                ...
                <img src="https://images-na.ssl-images-amazon.com/images/I/A1aH9HTkDkL.jpg" class="card-img-top" width="300" height="350">
                <div class="card-body">
                  <p class="card-text">Exploremos El Sistema Solar</p>
                </div>
              </div>
            </th>
          ...
          <th scope="col">
          <div class="card" style="width: 18rem; background-color: #bd69af; ">
            <img src="https://images-na.ssl-images-amazon.com/images/I/51mYSgcmJrL._SX372_BO1,204,203,200_.jpg" class="card-img-top" width="300" height="350">
            <div class="card-body">
              <p class="card-text">El Diario De Cereza Tomo 1 El Zoologico Petrificado</p>
            </div>
          </div>
        </th>
      ...
      <th scope="col">
        <div class="card" style="width: 18rem; background-color: #bd69af; ">
        <img src="https://imagenes.literaturasm.com/ecat_Imagenes/Original/136137_178660.jpg" class="card-img-top" width="300" height="350">
        <div class="card-body">
          <p class="card-text">las aventuras del capitán calzoncillos</p>
        </div>
      </div>
    </th>
      ...
      <div class="carousel-item">
          ...
          <table class="table table-borderless">
            <thead>
              <tr>
                ...
                <th scope="col">
                  <div class="card" style="width: 18rem; background-color: #bd69af; ">
                  <img src="https://images.cdn2.buscalibre.com/fit-in/360x360/66/3e/663e387db2bd61d35e210af181ca44ec.jpg" class="card-img-top" width="300" height="350">
                  <div class="card-body">
                    <p class="card-text">Abraza Tu Miedo</p>
                  </div>
                </div>
              </th>
            ...
            <th scope="col">
            <div class="card" style="width: 18rem; background-color: #bd69af; ">
            <img src="https://www.normainfantilyjuvenil.com/co/uploads/2019/01/resized/800_9789580010715.jpg" class="card-img-top" width="300" height="350">
            <div class="card-body">
              <p class="card-text">El Mas Poderoso</p>
            </div>
          </div>
        </th>
        ...
        <th scope="col">
          <div class="card" style="width: 18rem; background-color: #bd69af; ">
          <img src="https://www.planetadelibros.com.co/usuaris/libros/fotos/274/m_libros/273058_portada_el-principe-del-sol_claudia-ramirez-lomeli_201807170056.jpg" class="card-img-top" width="300" height="350">
          <div class="card-body">
            <p class="card-text">El príncipe del sol</p>
          </div>
        </div>
      </th>
  ...
  <table class="table table-borderless">
            ...
            <th scope="col">
              <div class="card" style="width: 18rem; background-color: #bd69af;">
                <img src="https://images-na.ssl-images-amazon.com/images/I/61NDZ0HCTQL._SX258_BO1,204,203,200_.jpg" class="card-img-top"  width="300" height="350">
                <div class="card-body">
                  <h5 class="card-title">Franklin se pierde</h5>
                  <p class="card-text">Paulette Bourgeois</p>
          ...
          <th scope="col">
            <div class="card" style="width: 18rem; background-color: #bd69af;">
              <img src="https://images-na.ssl-images-amazon.com/images/I/51lr3MDiaDL._SX374_BO1,204,203,200_.jpg" class="card-img-top"  width="300" height="350">
              <div class="card-body">
                <h5 class="card-title">Por Suerte Se Tienen Amigos</h5>
                <p class="card-text">Julia Boehme</p>
                <a href="#" class="btn btn-primary">Obtenlo</a>
              </div>
            </div>
        </th>
    ...
    <table class="table table-borderless">
      ...
      <th scope="col">
        <div class="card" style="width: 18rem; background-color: #bd69af;">
          <img src="https://contentv2.tap-commerce.com/cover/large/9789501302684_1.jpg?id_com=717" class="card-img-top"  width="300" height="350">
          <div class="card-body">
            <h5 class="card-title">Las aventuras de Huckleberry Finn</h5>
    ...
    <th scope="col">
      <div class="card" style="width: 18rem; background-color: #bd69af;">
        <img src="https://images-na.ssl-images-amazon.com/images/I/81dHXLsc+CL.jpg" class="card-img-top"  width="300" height="350">
        <div class="card-body">
          <h5 class="card-title">A la orilla de la luz</h5>
          <p class="card-text">Simon Vargas</p>
          <a href="#" class="btn btn-primary">Obtenlo</a>
        </div>
      </div>
  </th>
...
<table class="table table-borderless">
  ...
  <th scope="col">
    <div class="card" style="width: 18rem; background-color: #bd69af;">
      <img src="https://images-na.ssl-images-amazon.com/images/I/81mB9hd290L.jpg" class="card-img-top"  width="300" height="350">
      <div class="card-body">
        <h5 class="card-title">Como esconder un leon</h5>
        <p class="card-text">Helen Stephens</p>
        <a href="#" class="btn btn-primary">Obtenlo</a>
      </div>
    </div>
</th>
...
<th scope="col">
  <div class="card" style="width: 18rem; background-color: #bd69af;">
    <img src="https://tiendateatral.com/10320/libro-el-sr-brown-hace-muuu-podrias-hacerlo-tu.jpg" class="card-img-top"  width="300" height="350">
    <div class="card-body">
      <h5 class="card-title">¡El Sr. Brown hace muuu! ¿Podrias hacerlo tú?</h5>
