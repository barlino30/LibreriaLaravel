...
background-size:cover;
    ...
    <nav class="navbar navbar-expand-md navbar-dark fixed-top navbar-light" style="background-color: #0b1e35;">
      ...
      <!-- despegable -->
        ...
        <div class="dropdown-menu" style="background-color: #ac9ece;">
          <a class="dropdown-item" style="background-color: #32d45b;"><font face="cambria" style="background-color: ">Generos</font></a>
  ...
  <table class="table">
    ...
    <br>
    <p><h1 style="color:#60c96e">Mis productos</h1></p>
    ...
    <table class="table">
        ...
        <tbody>
            <tr>
                <th scope="row" style="background-color: #D6E0E5 ">1</th>
            </tr>
        </tbody>
    </table>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <p>Has realizado tu compra con exito.</p>
            </div>
    ...
    <br><br>
    <h2><button type="button" data-toggle="modal" data-target="#modal1" class="btn btn-outline-secondary"><font face="monaco" size="6">Adquierelo</font></button></h2>
