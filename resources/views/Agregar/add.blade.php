...
background-size:cover;
  ...
  <table class="table">
    ...
    <br>
    <p><h1 style="color:#60c96e">Crear</h1></p>
    <br>
    <div class="contaiber">
      <div class="row">
         <div class="col-md-12">
          <form action=" {{url('Creado')}} " method="GET">
            @csrf 
              <div class="label">Nombre</div>
              <input class="form-control" type="text" name="Nombre" id="">
              <div class="label">Autor</div>
              <input class="form-control" type="text" name="Autor" id="">
            ...
            <button type="submit" class="btn btn-outline-secondary"><font face="monaco" size="6">Enviar</font></button>
            </form>
          </div>
        </div>
    </div>
