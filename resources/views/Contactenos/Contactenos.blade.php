  ...
  <body>
    ...
    <br><div class="ewk_cont_banner">
      <div class="ew_cont_banner">
        <br><br><br><br>
    <h2><font face="lucida bright" size="15" color="#5880b1"> Contactenos</font></h2>
    <br><br>
    <h2><font face="monaco" size="10" color="#000000">
        Nos puedes localizar de diferentes formas:
    <br>En nuestra linea de Atencion de manera internacional: </font></h2>
    <h2><font face="monaco" size="10" color="#C286F7">
    <br>018000 564812</font></h2>
    <br><h2><font face="monaco" size="10" color="#000000">
        Tambien esta nuestra linea a Bogota:</font></h2>
    <br><font face="monaco" size="10" color="#C286F7">
        3651487</font></h2>
    <br><h2><font face="monaco" size="10" color="#000000">
        Nuestro Sede se enceuntra establecido:
    <br>Cra20G #35-27(Neiva-Huila)
    <br>O puedes tambien localizarnos en nuestras redes sociales.
