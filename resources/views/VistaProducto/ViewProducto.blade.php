...
background-size:cover;
  ...
  <table class="table">
    ...
    Cuenta la historia de una pasión dentro de un triángulo amoroso 
    formado por Anna, Karenin y Wronski. El triángulo se rompe 
    cuando Anna decide dejar a su familia y seguir a su amante, 
    pero el peso de su decisión hará que la bella joven termine 
    trágicamente esta historia y hunda a quienes la rodean en el 
    remolino de la desdicha. Sin embargo, Tolstoi no se queda 
    solamente en la historia del desencuentro de los amantes. 
    La novela también cruza otras vidas que funcionan como contrapunto
    y completan una visión universal —esa a la que aspira el 
    escritor— de las relaciones sentimentales entre los hombres, 
    el deber la renuncia y el éxito.
    </font> </h2>
    <br><br>
    <table class="table table-borderless">
        <thead>
            <tr>
                <th><h2><font face="monaco" size="6" color="#77858B  ">Autor: Lev Tolstói </font></h2></th>
