...
background-repeat: no-repeat;
background-size:cover;
background-image: url("https://www.ecestaticos.com/imagestatic/clipping/a26/81c/a2681c34b413c6cec7c86babadcdbebc/los-10-libros-de-empresa-de-2015-segun-los-lideres-empresariales-espanoles.jpg?mtime=1579565836");
}
  ...
  <body>
    ...
    <center>
        <br><div class="ewk_cont_banner">
          ...
          <div class="ew_cont_banne">
            <br><br><br><br>
        <h2><font face="lucida bright" size="15" color="#5880b1">¿Quienes somos?</font></h2>
        <br><br>
        <h2><font face="monaco" size="10" color="#000000">
            Nuestra Sede se encarga de la compra y venta de libros,
        estos a muy buena calidad, y siempre pensando en el gusto
        de nuestros clientes, traemos todo tipo de categorias, 
        incluyendo por su puestos para nuestros Profesionales.     
        <br><br>  
